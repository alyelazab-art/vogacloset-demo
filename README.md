...
| 1 | Normal Orders (ongoing) | Customers earn points based on their **current tier**: T1 & T2 → 1 pt/$1 ; T3 → 2 pts/$1 ; T4 → 3 pts/$1. Points valid **6 months from activation date**. Points tagged **"Extra"**. | ✅ Live (untagged) | ✅ Verified | All points earned through orders are classified undert "Cash back points" |
...
| 5 | Basket Size (valid 2 weeks) | **Buy 2 items → 2× (60d)** · **Buy 3 items → 3× (60d)** · **Buy 4 items → 4× (60d)** · **Buy 5+ items → 5× (60d)**. Campaign itself runs for 2 weeks. | ⚪ Not configured | — | 🔴 No quantity in the payload of the overall cart |
